...
var getProductById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                queryText = "SELECT * FROM Product WHERE id = $id";
...
var createProduct = function (Product) { return __awaiter(void 0, void 0, void 0, function () {
    var name, price, category, queryText, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                name = Product.name, price = Product.price, category = Product.category;
                queryText = "INSERT INTO Product (name, price, category) VALUES (?, ?, ?) RETURNING *";
                return [4 /*yield*/, database_1["default"].query(queryText, [name, price, category])];
            case 1:
                data = _a.sent();
